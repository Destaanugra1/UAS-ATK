    ...
    <div className="max-w-5xl mx-auto p-4">
      <div className="bg-white rounded-lg shadow-md p-4 flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:pl-6 mt-4 md:mt-0">
          <h1 className="text-blue-600 text-lg font-semibold">{data.title}</h1>
          <div className="text-blue-600 text-lg font-semibold">
            Tipe Produck: <span className="text-blue-800">{data.description}</span>
          </div>
          ...
          <div className="mt-4 flex">
            <button className="bg-green-500 text-white px-6 py-2 rounded-full mr-2">
              Beli Sekarang
            </button>
            <Link href="/" className="bg-blue-600 text-white px-6 py-2 rounded-full">
              Back
            </Link>
          </div>
        </div>
